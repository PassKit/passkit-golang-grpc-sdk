...
var file_io_flights_flight_proto_goTypes = []interface{}{
...
func file_io_flights_flight_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_io_flights_flight_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Flight); i {
			case 0:
				return &v.state
			case 1:
		...
		file_io_flights_flight_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
