...
var file_io_flights_flight_designator_proto_goTypes = []interface{}{
...
func file_io_flights_flight_designator_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_io_flights_flight_designator_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_io_flights_flight_designator_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*FlightDesignatorRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_io_flights_flight_designator_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_io_flights_flight_designator_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*FlightTimes); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
