...
var file_io_flights_cabin_codes_cabin_codes_proto_rawDesc = string([]byte{
...
var (
	...
	file_io_flights_cabin_codes_cabin_codes_proto_rawDescData []byte
)
...
func file_io_flights_cabin_codes_cabin_codes_proto_rawDescGZIP() []byte {
	file_io_flights_cabin_codes_cabin_codes_proto_rawDescOnce.Do(func() {
		file_io_flights_cabin_codes_cabin_codes_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_io_flights_cabin_codes_cabin_codes_proto_rawDesc), len(file_io_flights_cabin_codes_cabin_codes_proto_rawDesc)))
	})
...
var file_io_flights_cabin_codes_cabin_codes_proto_goTypes = []any{
...
func file_io_flights_cabin_codes_cabin_codes_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_io_flights_cabin_codes_cabin_codes_proto_rawDesc), len(file_io_flights_cabin_codes_cabin_codes_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   0,
			NumExtensions: 0,
			NumServices:   0,
