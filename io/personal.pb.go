...
type Person struct {
	...
	ExternalIds   map[int32]string `protobuf:"bytes,12,rep,name=externalIds,proto3" json:"externalIds,omitempty" protobuf_key:"varint,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value" validateGeneric:"-" validateCreate:"omitempty" validateUpdate:"-"`
...
var file_io_common_personal_proto_rawDesc = string([]byte{
...
var (
	...
	file_io_common_personal_proto_rawDescData []byte
)

func file_io_common_personal_proto_rawDescGZIP() []byte {
	file_io_common_personal_proto_rawDescOnce.Do(func() {
		file_io_common_personal_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_io_common_personal_proto_rawDesc), len(file_io_common_personal_proto_rawDesc)))
	})
...
var file_io_common_personal_proto_goTypes = []any{
...
func file_io_common_personal_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_io_common_personal_proto_rawDesc), len(file_io_common_personal_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   0,
