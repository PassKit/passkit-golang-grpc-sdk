...
var file_io_raw_project_proto_goTypes = []interface{}{
...
func file_io_raw_project_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_io_raw_project_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*PassProject); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_io_raw_project_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*PassProjectCopyRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
