...
var file_io_common_metrics_proto_rawDesc = []byte{
	...
	0x74, 0x2a, 0xb9, 0x02, 0x0a, 0x0f, 0x4c, 0x69, 0x66, 0x65, 0x63, 0x79, 0x63, 0x6c, 0x65, 0x45,
	...
	0x43, 0x4f, 0x4e, 0x46, 0x49, 0x52, 0x4d, 0x45, 0x44, 0x10, 0x80, 0x80, 0x20, 0x2a, 0x59, 0x0a,
	0x06, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x12, 0x0f, 0x0a, 0x0b, 0x50, 0x41, 0x53, 0x53, 0x5f,
	0x49, 0x53, 0x53, 0x55, 0x45, 0x44, 0x10, 0x00, 0x12, 0x12, 0x0a, 0x0e, 0x50, 0x41, 0x53, 0x53,
	0x5f, 0x49, 0x4e, 0x53, 0x54, 0x41, 0x4c, 0x4c, 0x45, 0x44, 0x10, 0x01, 0x12, 0x14, 0x0a, 0x10,
	0x50, 0x41, 0x53, 0x53, 0x5f, 0x55, 0x4e, 0x49, 0x4e, 0x53, 0x54, 0x41, 0x4c, 0x4c, 0x45, 0x44,
	0x10, 0x02, 0x12, 0x14, 0x0a, 0x10, 0x50, 0x41, 0x53, 0x53, 0x5f, 0x49, 0x4e, 0x56, 0x41, 0x4c,
	0x49, 0x44, 0x41, 0x54, 0x45, 0x44, 0x10, 0x03, 0x42, 0x47, 0x0a, 0x10, 0x63, 0x6f, 0x6d, 0x2e,
...
var file_io_common_metrics_proto_goTypes = []interface{}{
...
func file_io_common_metrics_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_io_common_metrics_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_io_common_metrics_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*UTM); i {
			case 0:
				return &v.state
			case 1:
		...
		file_io_common_metrics_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*MetaLocation); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_io_common_metrics_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
