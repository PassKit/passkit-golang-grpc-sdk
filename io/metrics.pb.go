...
const (
	...
	UtmSource_SOURCE_MOBILE     UtmSource = 2
...
type Metadata struct {
	...
	// IP address of the device where the pass was installe on. Not Writeable.
	...
	IssueAt *timestamp.Timestamp `protobuf:"bytes,11,opt,name=issueAt,proto3" json:"issueAt,omitempty"`
	// Date the pass was first displayed to the user to install. Not Writable.
	RenderedAt *timestamp.Timestamp `protobuf:"bytes,12,opt,name=renderedAt,proto3" json:"renderedAt,omitempty"`
	// Date the pass was first installed in a mobile wallet. Not Writable.
	FirstInstalledAt *timestamp.Timestamp `protobuf:"bytes,13,opt,name=firstInstalledAt,proto3" json:"firstInstalledAt,omitempty"`
	...
	LastInstalledAt *timestamp.Timestamp `protobuf:"bytes,14,opt,name=lastInstalledAt,proto3" json:"lastInstalledAt,omitempty"`
	...
	FirstUninstalledAt *timestamp.Timestamp `protobuf:"bytes,15,opt,name=firstUninstalledAt,proto3" json:"firstUninstalledAt,omitempty"`
	// Date the pass was last uninstalled from a mobile wallet. Not Writable.
	LastUninstalledAt *timestamp.Timestamp `protobuf:"bytes,16,opt,name=lastUninstalledAt,proto3" json:"lastUninstalledAt,omitempty"`
	// Date the pass was invalidated. Not Writable.
	InvalidatedAt *timestamp.Timestamp `protobuf:"bytes,17,opt,name=invalidatedAt,proto3" json:"invalidatedAt,omitempty"`
	// Date the pass record was last updated. Can be used for segmenting passes based 'last visit', or 'last-purchase'. Not Writable.
	LastUpdatedAt        *timestamp.Timestamp `protobuf:"bytes,18,opt,name=lastUpdatedAt,proto3" json:"lastUpdatedAt,omitempty"`
	XXX_NoUnkeyedLiteral struct{}             `json:"-"`
	XXX_unrecognized     []byte               `json:"-"`
	XXX_sizecache        int32                `json:"-"`
}
...
var fileDescriptor_e3ee370c4b50b41a = []byte{
	...
	,
}
