...
type Quota struct {
	...
	Details       map[uint32]*QuotaDetails `protobuf:"bytes,1,rep,name=details,proto3" json:"details,omitempty" protobuf_key:"varint,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"` // key is one of pk.MeteredEventType
...
var file_io_common_billing_proto_rawDesc = string([]byte{
...
var (
	...
	file_io_common_billing_proto_rawDescData []byte
)

func file_io_common_billing_proto_rawDescGZIP() []byte {
	file_io_common_billing_proto_rawDescOnce.Do(func() {
		file_io_common_billing_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_io_common_billing_proto_rawDesc), len(file_io_common_billing_proto_rawDesc)))
	})
...
func file_io_common_billing_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_io_common_billing_proto_rawDesc), len(file_io_common_billing_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
