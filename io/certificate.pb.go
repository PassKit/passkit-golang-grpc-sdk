...
var file_io_certificate_certificate_proto_rawDesc = []byte{
...
var (
	...
	file_io_certificate_certificate_proto_rawDescData = file_io_certificate_certificate_proto_rawDesc
)

func file_io_certificate_certificate_proto_rawDescGZIP() []byte {
	file_io_certificate_certificate_proto_rawDescOnce.Do(func() {
		file_io_certificate_certificate_proto_rawDescData = protoimpl.X.CompressGZIP(file_io_certificate_certificate_proto_rawDescData)
	})
...
var file_io_certificate_certificate_proto_goTypes = []interface{}{
...
func file_io_certificate_certificate_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_io_certificate_certificate_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_io_certificate_certificate_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_io_certificate_certificate_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_io_certificate_certificate_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*TLSCertificateData); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_io_certificate_certificate_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*PrivateKeyData); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_io_certificate_certificate_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*PassTypeIdentifier); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_io_certificate_certificate_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
		...
		file_io_certificate_certificate_proto_msgTypes[7].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*NFCSigningCredentialsRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_io_certificate_certificate_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   8,
			NumExtensions: 0,
			NumServices:   0,
	...
	file_io_certificate_certificate_proto_rawDesc = nil
