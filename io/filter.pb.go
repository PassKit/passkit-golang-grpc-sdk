...
var file_io_common_filter_proto_rawDesc = []byte{
...
var (
	...
	file_io_common_filter_proto_rawDescData = file_io_common_filter_proto_rawDesc
)

func file_io_common_filter_proto_rawDescGZIP() []byte {
	file_io_common_filter_proto_rawDescOnce.Do(func() {
		file_io_common_filter_proto_rawDescData = protoimpl.X.CompressGZIP(file_io_common_filter_proto_rawDescData)
	})
...
var file_io_common_filter_proto_goTypes = []interface{}{
...
func file_io_common_filter_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_io_common_filter_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_io_common_filter_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_io_common_filter_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_io_common_filter_proto_rawDesc,
			NumEnums:      1,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
	...
	file_io_common_filter_proto_rawDesc = nil
