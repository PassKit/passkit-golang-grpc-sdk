...
type EventDetails struct {
	...
	// @tag: validateCreate:"omitempty"
	MetaData map[string]string `protobuf:"bytes,8,rep,name=metaData,proto3" json:"metaData,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value" validateCreate:"omitempty"`
...
var file_io_member_event_proto_rawDesc = string([]byte{
...
var (
	...
	file_io_member_event_proto_rawDescData []byte
)

func file_io_member_event_proto_rawDescGZIP() []byte {
	file_io_member_event_proto_rawDescOnce.Do(func() {
		file_io_member_event_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_io_member_event_proto_rawDesc), len(file_io_member_event_proto_rawDesc)))
	})
...
func file_io_member_event_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_io_member_event_proto_rawDesc), len(file_io_member_event_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
