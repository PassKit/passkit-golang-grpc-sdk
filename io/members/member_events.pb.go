...
var file_io_member_member_events_proto_goTypes = []interface{}{
...
func file_io_member_member_events_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_io_member_member_events_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_io_member_member_events_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*MemberMininmal); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
