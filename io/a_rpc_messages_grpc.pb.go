...
const (
	Messages_GetMessage_FullMethodName    = "/io.Messages/getMessage"
	Messages_CreateMessage_FullMethodName = "/io.Messages/createMessage"
	Messages_UpdateMessage_FullMethodName = "/io.Messages/updateMessage"
	Messages_DeleteMessage_FullMethodName = "/io.Messages/deleteMessage"
	Messages_SendMessage_FullMethodName   = "/io.Messages/sendMessage"
)
...
func (c *messagesClient) CreateMessage(ctx context.Context, in *Message, opts ...grpc.CallOption) (*Id, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Id)
	err := c.cc.Invoke(ctx, Messages_CreateMessage_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedMessagesServer should be embedded to have
