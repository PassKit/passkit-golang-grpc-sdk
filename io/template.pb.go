...
var file_io_common_template_proto_rawDesc = []byte{
	...
	0x73, 0x65, 0x74, 0x73, 0x22, 0xf7, 0x02, 0x0a, 0x13, 0x41, 0x70, 0x70, 0x6c, 0x65, 0x57, 0x61,
	...
	0x70, 0x69, 0x6e, 0x67, 0x49, 0x64, 0x65, 0x6e, 0x74, 0x69, 0x66, 0x69, 0x65, 0x72, 0x22, 0xe4,
	...
	0x02, 0x42, 0x47, 0x0a, 0x10, 0x63, 0x6f, 0x6d, 0x2e, 0x70, 0x61, 0x73, 0x73, 0x6b, 0x69, 0x74,
...
var file_io_common_template_proto_msgTypes = make([]protoimpl.MessageInfo, 24)
var file_io_common_template_proto_goTypes = []interface{}{
	...
	(*TOPTParameters)(nil),                   // 17: io.TOPTParameters
	(*Barcode)(nil),                          // 18: io.Barcode
	(*PassTemplate)(nil),                     // 19: io.PassTemplate
	(*AppleWalletSettings)(nil),              // 20: io.AppleWalletSettings
	(*GooglePaySettings)(nil),                // 21: io.GooglePaySettings
	(*GooglePayApp)(nil),                     // 22: io.GooglePayApp
	(*Data)(nil),                             // 23: io.Data
	(*LandingPageSettings)(nil),              // 24: io.LandingPageSettings
	(*DataCollectionPageSettings)(nil),       // 25: io.DataCollectionPageSettings
	(*PasswordSettings)(nil),                 // 26: io.PasswordSettings
	(*PassTemplateResponse)(nil),             // 27: io.PassTemplateResponse
	(*Colors)(nil),                           // 28: io.Colors
	(*CopyObjectInput)(nil),                  // 29: io.CopyObjectInput
	(*NFC)(nil),                              // 30: io.NFC
	(*DataField)(nil),                        // 31: io.DataField
	(*AppleWalletFieldRenderOptions)(nil),    // 32: io.AppleWalletFieldRenderOptions
	(*GooglePayFieldRenderOptions)(nil),      // 33: io.GooglePayFieldRenderOptions
	(*PositionSettings)(nil),                 // 34: io.PositionSettings
	(*DataCollectionFieldRenderOptions)(nil), // 35: io.DataCollectionFieldRenderOptions
	(*AddressRenderOptions)(nil),             // 36: io.AddressRenderOptions
	(*Sharing)(nil),                          // 37: io.Sharing
	(*DefaultTemplateRequest)(nil),           // 38: io.DefaultTemplateRequest
	nil,                                      // 39: io.LandingPageSettings.LocalizedTextOverridesEntry
	(*LocalizedString)(nil),                  // 40: io.LocalizedString
	(PassProtocol)(0),                        // 41: io.PassProtocol
	(LanguageCode)(0),                        // 42: io.LanguageCode
	(*ImageIds)(nil),                         // 43: io.ImageIds
	(*ImageData)(nil),                        // 44: io.ImageData
	(*GPSLocation)(nil),                      // 45: io.GPSLocation
	(*Beacon)(nil),                           // 46: io.Beacon
	(*Link)(nil),                             // 47: io.Link
	(*ExpirySettings)(nil),                   // 48: io.ExpirySettings
	(*Url)(nil),                              // 49: io.Url
	(Toggle)(0),                              // 50: io.Toggle
	(*TrackingSettings)(nil),                 // 51: io.TrackingSettings
	(*timestamppb.Timestamp)(nil),            // 52: google.protobuf.Timestamp
	(UsageType)(0),                           // 53: io.UsageType
}
var file_io_common_template_proto_depIdxs = []int32{
	40, // 0: io.SelectOption.localizedTextLabel:type_name -> io.LocalizedString
	2,  // 1: io.Barcode.format:type_name -> io.BarcodeType
	40, // 2: io.Barcode.localizedAltText:type_name -> io.LocalizedString
	17, // 3: io.Barcode.totpParameters:type_name -> io.TOPTParameters
	41, // 4: io.PassTemplate.protocol:type_name -> io.PassProtocol
	42, // 5: io.PassTemplate.defaultLanguage:type_name -> io.LanguageCode
	40, // 6: io.PassTemplate.localizedOrganizationName:type_name -> io.LocalizedString
	40, // 7: io.PassTemplate.localizedDescription:type_name -> io.LocalizedString
	23, // 8: io.PassTemplate.data:type_name -> io.Data
	43, // 9: io.PassTemplate.imageIds:type_name -> io.ImageIds
	44, // 10: io.PassTemplate.images:type_name -> io.ImageData
	28, // 11: io.PassTemplate.colors:type_name -> io.Colors
	18, // 12: io.PassTemplate.barcode:type_name -> io.Barcode
	30, // 13: io.PassTemplate.nfcEnabled:type_name -> io.NFC
	37, // 14: io.PassTemplate.sharing:type_name -> io.Sharing
	20, // 15: io.PassTemplate.appleWalletSettings:type_name -> io.AppleWalletSettings
	21, // 16: io.PassTemplate.googlePaySettings:type_name -> io.GooglePaySettings
	45, // 17: io.PassTemplate.locations:type_name -> io.GPSLocation
	46, // 18: io.PassTemplate.beacons:type_name -> io.Beacon
	47, // 19: io.PassTemplate.links:type_name -> io.Link
	48, // 20: io.PassTemplate.expirySettings:type_name -> io.ExpirySettings
	24, // 21: io.PassTemplate.landingPageSettings:type_name -> io.LandingPageSettings
	...
	1,  // 24: io.GooglePaySettings.passType:type_name -> io.GooglePayPassType
	22, // 25: io.GooglePaySettings.androidApp:type_name -> io.GooglePayApp
	22, // 26: io.GooglePaySettings.iosApp:type_name -> io.GooglePayApp
	22, // 27: io.GooglePaySettings.webApp:type_name -> io.GooglePayApp
	42, // 28: io.GooglePaySettings.languageOverrides:type_name -> io.LanguageCode
	49, // 29: io.GooglePayApp.url:type_name -> io.Url
	40, // 30: io.GooglePayApp.localizedTitle:type_name -> io.LocalizedString
	40, // 31: io.GooglePayApp.localizedDescription:type_name -> io.LocalizedString
	40, // 32: io.GooglePayApp.localizedUrlDescription:type_name -> io.LocalizedString
	31, // 33: io.Data.dataFields:type_name -> io.DataField
	25, // 34: io.Data.dataCollectionPageSettings:type_name -> io.DataCollectionPageSettings
	42, // 35: io.LandingPageSettings.landingLocalizationOverride:type_name -> io.LanguageCode
	50, // 36: io.LandingPageSettings.preferThirdPartyAndroidWallet:type_name -> io.Toggle
	15, // 37: io.LandingPageSettings.preferredAndroidWallet:type_name -> io.SupportedAndroidWallet
	39, // 38: io.LandingPageSettings.localizedTextOverrides:type_name -> io.LandingPageSettings.LocalizedTextOverridesEntry
	40, // 39: io.DataCollectionPageSettings.localizedTitle:type_name -> io.LocalizedString
	40, // 40: io.DataCollectionPageSettings.localizedDescription:type_name -> io.LocalizedString
	40, // 41: io.DataCollectionPageSettings.localizedSubmitButtonText:type_name -> io.LocalizedString
	40, // 42: io.DataCollectionPageSettings.localizedLoadingText:type_name -> io.LocalizedString
	40, // 43: io.DataCollectionPageSettings.localizedThankYouText:type_name -> io.LocalizedString
	40, // 44: io.DataCollectionPageSettings.localizedPageBackgroundColor:type_name -> io.LocalizedString
	51, // 45: io.DataCollectionPageSettings.trackingSettings:type_name -> io.TrackingSettings
	40, // 46: io.DataCollectionPageSettings.localizedFooterText:type_name -> io.LocalizedString
	26, // 47: io.DataCollectionPageSettings.passwordSettings:type_name -> io.PasswordSettings
	14, // 48: io.PasswordSettings.passwordType:type_name -> io.PasswordType
	40, // 49: io.PasswordSettings.localizedInputLabelText:type_name -> io.LocalizedString
	40, // 50: io.PasswordSettings.localizedErrorText:type_name -> io.LocalizedString
	40, // 51: io.PasswordSettings.localizedHeaderText:type_name -> io.LocalizedString
	40, // 52: io.PasswordSettings.localizedButtonText:type_name -> io.LocalizedString
	40, // 53: io.PasswordSettings.localizedTitleText:type_name -> io.LocalizedString
	19, // 54: io.PassTemplateResponse.template:type_name -> io.PassTemplate
	41, // 55: io.PassTemplateResponse.protocol:type_name -> io.PassProtocol
	52, // 56: io.PassTemplateResponse.createdAt:type_name -> google.protobuf.Timestamp
	52, // 57: io.PassTemplateResponse.updatedAt:type_name -> google.protobuf.Timestamp
	3,  // 58: io.DataField.fieldType:type_name -> io.FieldType
	40, // 59: io.DataField.localizedLabel:type_name -> io.LocalizedString
	10, // 60: io.DataField.dataType:type_name -> io.DataType
	40, // 61: io.DataField.localizedDefaultValue:type_name -> io.LocalizedString
	32, // 62: io.DataField.appleWalletFieldRenderOptions:type_name -> io.AppleWalletFieldRenderOptions
	35, // 63: io.DataField.dataCollectionFieldRenderOptions:type_name -> io.DataCollectionFieldRenderOptions
	53, // 64: io.DataField.usage:type_name -> io.UsageType
	33, // 65: io.DataField.googlePayFieldRenderOptions:type_name -> io.GooglePayFieldRenderOptions
	5,  // 66: io.AppleWalletFieldRenderOptions.textAlignment:type_name -> io.TextAlignment
	34, // 67: io.AppleWalletFieldRenderOptions.positionSettings:type_name -> io.PositionSettings
	40, // 68: io.AppleWalletFieldRenderOptions.localizedChangeMessage:type_name -> io.LocalizedString
	6,  // 69: io.AppleWalletFieldRenderOptions.dateStyle:type_name -> io.DateTimeStyle
	6,  // 70: io.AppleWalletFieldRenderOptions.timeStyle:type_name -> io.DateTimeStyle
	8,  // 71: io.AppleWalletFieldRenderOptions.numberStyle:type_name -> io.NumberStyle
	7,  // 72: io.AppleWalletFieldRenderOptions.suppressLinkDetection:type_name -> io.LinkDetector
	13, // 73: io.GooglePayFieldRenderOptions.googlePayPosition:type_name -> io.GooglePayField
	12, // 74: io.PositionSettings.section:type_name -> io.FieldSection
	40, // 75: io.DataCollectionFieldRenderOptions.localizedHelpText:type_name -> io.LocalizedString
	16, // 76: io.DataCollectionFieldRenderOptions.selectOptions:type_name -> io.SelectOption
	40, // 77: io.DataCollectionFieldRenderOptions.localizedPlaceholder:type_name -> io.LocalizedString
	36, // 78: io.DataCollectionFieldRenderOptions.addressRenderOptions:type_name -> io.AddressRenderOptions
	40, // 79: io.AddressRenderOptions.localizedAddress1Label:type_name -> io.LocalizedString
	40, // 80: io.AddressRenderOptions.localizedAddress2Label:type_name -> io.LocalizedString
	40, // 81: io.AddressRenderOptions.localizedCityLabel:type_name -> io.LocalizedString
	40, // 82: io.AddressRenderOptions.localizedCountryLabel:type_name -> io.LocalizedString
	40, // 83: io.AddressRenderOptions.localizedZipLabel:type_name -> io.LocalizedString
	40, // 84: io.AddressRenderOptions.localizedAddress1Placeholder:type_name -> io.LocalizedString
	40, // 85: io.AddressRenderOptions.localizedAddress2Placeholder:type_name -> io.LocalizedString
	40, // 86: io.AddressRenderOptions.localizedCityPlaceholder:type_name -> io.LocalizedString
	40, // 87: io.AddressRenderOptions.localizedCountryPlaceholder:type_name -> io.LocalizedString
	40, // 88: io.AddressRenderOptions.localizedZipPlaceholder:type_name -> io.LocalizedString
	40, // 89: io.Sharing.localizedDescription:type_name -> io.LocalizedString
	41, // 90: io.DefaultTemplateRequest.protocol:type_name -> io.PassProtocol
	40, // 91: io.LandingPageSettings.LocalizedTextOverridesEntry.value:type_name -> io.LocalizedString
